"""
GLB Optimizer - Core optimization orchestrator module.
...
# Import handlers - using late import pattern to avoid circular dependency
# The handlers will import GLBOptimizer from this module when they need it
class GLBOptimizer:
