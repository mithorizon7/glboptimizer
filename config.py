...
class OptimizationConfig:
    ...
    def __init__(self):
        ...
        self.SUBPROCESS_TIMEOUT = int(os.environ.get('GLB_SUBPROCESS_TIMEOUT', '300'))  # 5 minutes for thorough optimization
        self.PARALLEL_TIMEOUT = int(os.environ.get('GLB_PARALLEL_TIMEOUT', '120'))  # 2 minutes for complete parallel testing
